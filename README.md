...
This fork contains API usage pattern samples for Microsoft's Universal Windows Platform (**UWP**) in Windows 10 SDK.  
Samples were created with Visual Studio **UWP** templates for devices supporting the Universal Windows Platform.

> **Notes:**
> For more info on working with the samples collection and GitHub, see [Get the **UWP** samples from GitHub](https://aka.ms/ovu2uq).  
> Search for samples at the [Code Samples](https://aka.ms/winsamples) portal. 

## Universal Windows Platform development

These samples require Visual Studio 2017 Update 4 or higher and Windows Software Development Kit (SDK) version 17134 for Windows 10.

   [Get Visual Studio 2017 Community Edition with **UWP** app support](http://go.microsoft.com/fwlink/p/?LinkID=280676)

## Using the samples

   **Note:** 
   * In Visual Studio 2017, the platform target defaults to **ARM**;  change that to **x64** or **x86** for non-ARM devices. 
   
The samples use Linked files in Visual Studio to reduce duplication of common files, including sample template files and image assets.  
Common files are stored in the SharedContent folder at the root of the repository, and are referred to in the project files using links.

Guidance, tutorials, and reference topics are provided in the Windows 10 documentation available in the [Windows Developer Center](http://go.microsoft.com/fwlink/p/?LinkID=532421).
Microsoft provides samples as-is to demonstrate functionality of Windows programming models and feature APIs.

## Contributions

These samples from feature teams, who welcome your input on issues and suggestions for new samples.

That project adopted the [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).

## See also [Windows on GitHub](http://microsoft.github.io/windows/). 
